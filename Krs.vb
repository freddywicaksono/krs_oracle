Public Class Krs
    ...
    Public Sub Simpan()
        ...
        If (krs_baru = True) Then
            strsql = "Insert into krs(nomor_bukti,tanggal,nim,jenis_semester,tahun_akademik,semester,nidn) values ('" & _nomor_bukti & "','" & _tanggal & "','" & _nim & "','" & _jenis_semester & "','" & _tahun_akademik & "','" & _semester & "','" & _nidn & "')"
            info = "INSERT"
        Else
    ...
    Public Sub Carikrs(ByVal snomor_bukti As String)
        ...
        If (DR.HasRows = True) Then
            ...
            semester = Convert.ToInt16((DR("semester")))
